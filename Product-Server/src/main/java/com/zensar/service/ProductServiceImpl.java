...
/*	@Autowired
	...
	public ProductDto insertProduct(ProductDto productDto) {
		//CouponDto couponDto = restTemplate.getForObject("http://localhost:6000/coupons/coupon/"+productDto.getCode(),CouponDto.class);
		
	CouponDto couponDto=restclient.getByCouponCode(productDto.getCode());
	//	CouponDto couponDto = restTemplate.getForObject("http://Coupon-Service/coupons/coupon/"+productDto.getCode(),CouponDto.class);
